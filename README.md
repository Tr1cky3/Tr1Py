...
Proyek ini adalah implementasi *mini compiler* modular yang dirancang untuk mengenali, memvalidasi, dan menerjemahkan bahasa pemrograman Tr1Py dengan sintaksis unik ke dalam bentuk Kode Antara (**Three-Address Code / TAC**).
...
Bahasa Tr1Py memiliki aturan leksikal dan sintaksis unik yang berbeda dari bahasa pemrograman konvensional:
...
2. Buka terminal atau PowerShell pada direktori proyek tersebut.

3. Jalankan file utama menggunakan perintah:
